...
$sql = "SELECT po.*, p.product_name, p.product_code, ot.type_name, u.username 
        ...
        WHERE DATE(po.transaction_date) BETWEEN '$start_date' AND '$end_date'
        ORDER BY po.transaction_date DESC";

$result = $conn->query($sql);
$total_outgoing = $conn->query("SELECT SUM(quantity) as total FROM ($sql) as temp")->fetch_assoc()['total'];
?>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="mb-3">
                            ...
                            <h6>Total Barang Keluar: <span class="badge bg-success"><?php echo $total_outgoing; ?> item</span></h6>
                        </div>
